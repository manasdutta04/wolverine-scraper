  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="4" label="Studio Collectors" delay={500} />
        <ScrambleNumber target="60+" label="Trusted Signals" delay={800} />
        <ScrambleNumber target="3" label="Court Verdicts" delay={1100} />
        <ScrambleNumber target="1.1K" label="Catalog Rows" delay={1400} />
      </div>
    </div>
  );
}
